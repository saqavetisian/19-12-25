...
const translations = {
  ru: {
    ...
    'rsvp.text': 'Пожалуйста, подтвердите ваше присутствие до 10.12.25',
  },
  hy: {
    'groom.name': 'Վանիկ',
    'bride.name': 'Մարի',
    ...
    'rsvp.text': 'Խնդրում ենք հաստատել ձեր ներկայությունը մինչև 10․12․25',
  },
};
